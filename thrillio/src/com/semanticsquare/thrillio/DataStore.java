...
public class DataStore {
	...
	private static void loadMovies() {
		...
		bookmarks[1][4] = BookmarkManager.getInstance().createMovie(3004,	"Ikiru", "",  1952, new String[] {"Takashi Shimura","Minoru Chiaki"},	new String[] {"Akira Kurosawa"}, MovieGenre.FOREGIN_THRILLERS,	8.4); 
	}
    ...
    private static void loadBooks(){
    	...
    	bookmarks[2][2] = BookmarkManager.getInstance().createBook(4002,	"Light From Many Lamps", "", 1988,	"", new String[] {"Touchstone Lillian Eichler Watson"},	BookGenre.PHILOSOPHY, 5.0); 
    	bookmarks[2][3] = BookmarkManager.getInstance().createBook(4003,	"Head First Design Patterns", "",	2004, "", new String[]	{"O'Reilly Media	Eric Freeman","Bert Bates,Kathy Sierra","Elisabeth Robson"}, BookGenre.TECHNICAL,	4.5);
